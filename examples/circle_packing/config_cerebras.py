...
def build_evo_models() -> list[ModelSpec]:
    ...
    gpt_oss_120b_high = replace(gpt_oss_120b_med,
                                model_id="gpt-oss-120b-high",
                                settings=CerebrasModelSettings(openai_reasoning_effort="high"))
    
    return [gpt_oss_120b_med, gpt_oss_120b_high]
