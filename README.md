...
adrevo beats SOTA on 3/5 of the mathematical optimization benchmarks.
...
adrevo beats SOTA on 3/5 of the ADRS benchmarks.
...
* [skydiscover (AdaEvolve/EvoX)](https://github.com/skydiscover-ai/skydiscover)
